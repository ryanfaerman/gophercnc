...
//func (c *config) Machines() ([]Machine, error) {
//	out := []Machine{}
//	libs, err := c.queries.FindResourceByKind(c.ctx, sql.NullString{String: "machine", Valid: true})
//	if err != nil {
//		return out, err
//	}
...
//func (c *config) GetMachinePath(name string) (Machine, error) {
//	out := Machine{}
...
//	if err != nil {
//		err = fmt.Errorf("machine '%s' not found; %w", name, err)
//	}
...
//func (c *config) AddMachine(name, path string) error {
...
//		Kind: sql.NullString{String: "machine", Valid: true},
//	})
